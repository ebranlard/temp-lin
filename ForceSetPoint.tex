...
required to be initialized in the output type). The only exception to this is \textit{BeamDyn}, and 
...
\\tt{MeshMapData\%y_BD_BldMotion_4Loads(k)} should be used in place of \tt{y(k)\%BldMotion}.
